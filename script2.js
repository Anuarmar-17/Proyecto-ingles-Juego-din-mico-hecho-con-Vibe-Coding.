const words = [
    "between", "through", "always", "before", "laugh", "behind",
    "mirror", "travel", "afraid", "borrow", "quiet", "inside",
    "sometimes", "pocket", "autumn", "tired", "message", "wait",
    "answer", "minute"
];
...
function checkGameStatus() {
    ...
    } else if (mistakes >= 3) { // 🔹 Ahora es simétrico
...
function endGame(message, color) {
    ...
    if (message.includes("win")) {
        ...
        link.href = "index3.html"; // 👉 aquí pones la URL del nivel 2
        link.textContent = "Let's go to the level 3 🚀";
        link.target = "_self"; // abre en la misma pestaña
        link.style.display = "block";
        link.style.marginTop = "10px";
        link.style.color = "#1E90FF";
        link.style.fontWeight = "bold";
        link.style.textDecoration = "none"; // quita el subrayado
